...
import moe.plushie.armourers_workshop.compat.fabric.builder.AbstractFabricEntityTypeBuilder;
...
public class EntityTypeBuilderImpl<T extends Entity> implements IEntityTypeBuilder<T> {
    ...
    private final AbstractFabricEntityTypeBuilder<T> builder;

    public EntityTypeBuilderImpl(IEntityType.Serializer<T> serializer, MobCategory mobCategory) {
        this.builder = new AbstractFabricEntityTypeBuilder<>(serializer, mobCategory);
    }
