...
import moe.plushie.armourers_workshop.compat.forge.builder.AbstractForgeKeyMappingBuilder;
...
public class KeyMappingBuilderImpl<T extends IKeyMapping> implements IKeyMappingBuilder<T> {
    ...
    private final AbstractForgeKeyMappingBuilder<T> builder;

    public KeyMappingBuilderImpl(String key, IKeyCategory category) {
        this.builder = new AbstractForgeKeyMappingBuilder<>(key, category);
    }
