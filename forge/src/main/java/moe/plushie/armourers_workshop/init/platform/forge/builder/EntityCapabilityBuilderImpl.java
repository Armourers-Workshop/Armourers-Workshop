...
import moe.plushie.armourers_workshop.compat.forge.builder.AbstractForgeEntityCapabilityBuilder;
...
public class EntityCapabilityBuilderImpl<T> implements IEntityCapabilityBuilder<T> {
    ...
    private final AbstractForgeEntityCapabilityBuilder<T> builder;

    public EntityCapabilityBuilderImpl(Class<T> type, Function<Entity, Optional<T>> factory) {
        this.builder = new AbstractForgeEntityCapabilityBuilder<>(type, factory);
    }
