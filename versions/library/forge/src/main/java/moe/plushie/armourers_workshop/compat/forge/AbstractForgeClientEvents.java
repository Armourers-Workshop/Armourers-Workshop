...
import moe.plushie.armourers_workshop.compat.forge.event.client.AbstractForgeRegisterKeyMappingsEvent;
...
public class AbstractForgeClientEvents {
    ...
    public static void init() {
        ...
        EventManager.post(RenderLivingEntityEvent.Setup.class, AbstractForgeRenderLivingEvent.setupFactory());
