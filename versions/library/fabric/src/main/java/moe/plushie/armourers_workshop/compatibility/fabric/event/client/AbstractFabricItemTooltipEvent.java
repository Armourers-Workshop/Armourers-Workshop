...
public class AbstractFabricItemTooltipEvent {
    ...
    public static IEventHandler<ItemTooltipEvent.Render> renderFactory() {
        return (priority, receiveCancelled, subscriber) -> RenderTooltipEvents.BEFORE.register((itemStack, x, y, width, height, screenWidth, screenHeight, context) -> subscriber.accept(new ItemTooltipEvent.Render() {
            @Override
            public ItemStack getItemStack() {
                return itemStack;
            }
