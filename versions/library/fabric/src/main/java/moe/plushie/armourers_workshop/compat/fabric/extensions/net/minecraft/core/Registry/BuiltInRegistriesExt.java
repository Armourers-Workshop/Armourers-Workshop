...
public class BuiltInRegistriesExt {
    ...
    public static final auto CREATIVE_MODE_TAB = BuiltInRegistries.CREATIVE_MODE_TAB;
    public static final auto LOOT_FUNCTION_TYPE = BuiltInRegistries.LOOT_FUNCTION_TYPE;
