...
public class AbstractShaderContext implements ShaderContext {
    ...
    private final OpenVector2f polygonOffset = new OpenVector2f(0.0f, 0.0f);
    private final AbstractModelViewStack modelViewStack = AbstractModelViewStack.getInstance();

    private final AbstractShaderObjectState objects = new AbstractShaderObjectState();
    private final AbstractShaderUniformState uniforms = new AbstractShaderUniformState();
