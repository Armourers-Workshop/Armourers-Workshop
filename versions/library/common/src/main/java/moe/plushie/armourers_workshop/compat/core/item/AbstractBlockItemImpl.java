...
public class AbstractBlockItemImpl extends BlockItem {
    ...
    public OpenInteractionResult place(BlockPlaceContext context, Object service) {
        return AbstractInteractionResult.wrap(super.place(context));
    }

    @Override
    public InteractionResult place(BlockPlaceContext context) {
        return AbstractInteractionResult.unwrap(place(context, null));
    }
