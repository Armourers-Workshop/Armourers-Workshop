...
public abstract class AbstractRenderTypeBuilder extends SkinRenderType.Builder {
    ...
    private static class Provider extends RenderType {
        ...
        private static final Map<SkinVertexFormat, Supplier<SkinRenderType.Builder>> INSTANCES = Collections.immutableMap(it -> {
            ...
            it.put(SkinVertexFormat.GUI_TEXTURED, () -> _builder(DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, POSITION_COLOR_TEX_LIGHTMAP_SHADER));
        ...
        private static class Builder extends AbstractRenderTypeBuilder {
            ...
            public Builder lightmap(boolean flag) {
                if (flag) {
                    ...
                    stateBuilder.setLightmapState(NO_LIGHTMAP);
                }
                return this;
            }
