...
public class AbstractArmorStand extends AbstractArmorStandImpl implements AbstractEntityHandler {
    ...
    protected void abi$brokenByPlayer(ServerLevel serverLevel, DamageSource damageSource) {
        super.brokenByPlayer(serverLevel, damageSource, null);
    }

    protected void abi$brokenByAnything(ServerLevel serverLevel, DamageSource damageSource) {
        super.brokenByAnything(serverLevel, damageSource, null);
    }
    ...
    @Override
    public final void brokenByPlayer(ServerLevel serverLevel, DamageSource damageSource, Object context) {
        abi$brokenByPlayer(serverLevel, damageSource);
    }

    @Override
    public final void brokenByAnything(ServerLevel serverLevel, DamageSource damageSource, Object context) {
        abi$brokenByAnything(serverLevel, damageSource);
    }
