...
public class AbstractGuiGraphicsRenderer implements CGGraphicsRenderer {
    ...
    public static void wrap(GuiGraphics graphics, float width, float height, float mouseX, float mouseY, float partialTicks, Consumer<CGGraphicsContext> action) {
        var param = new CGGraphicsParameters(width, height, mouseX, mouseY, partialTicks, graphics);
