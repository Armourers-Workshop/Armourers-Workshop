...
public class AbstractBufferSource implements IBufferSource {
    ...
    private final Supplier<MultiBufferSource> impl;

    private AbstractBufferSource(Supplier<MultiBufferSource> impl) {
        this.impl = impl;
    }
    ...
    public IVertexConsumer getBuffer(IRenderType renderType) {
        ...
        return CACHED_BUFFER_BUILDERS.computeIfAbsent(builder, AbstractVertexConsumer::wrap);
    }
