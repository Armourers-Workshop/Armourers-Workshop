...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractGLUniform {
    ...
    AbstractGLUniform(String name) {
        this.name = name;
    }

    public static AbstractGLUniform integer(String name, Supplier<Integer> value) {
        return new IntValue(name, value);
    }

    public static AbstractGLUniform vector4f(String name, Supplier<OpenVector4f> value) {
        return new Vec4fValue(name, value);
    }

    public static AbstractGLUniform matrix4f(String name, Supplier<OpenMatrix4f> value) {
        return new Matrix4fValue(name, value);
    }

    public static AbstractGLUniform matrix3f(String name, Supplier<OpenMatrix3f> value) {
    ...
    private static class IntValue extends AbstractGLUniform {
    ...
    private static class Vec4fValue extends AbstractGLUniform {
    ...
    private static class Matrix4fValue extends AbstractGLUniform {
    ...
    private static class Matrix3fValue extends AbstractGLUniform {
