...
@Available("[18, 26)")
public abstract class AbstractRenderTypeImpl extends RenderType {
    ...
    private AbstractRenderTypeImpl(String name, RenderType delegate, boolean affectsCrumbling, boolean sortUpload, Runnable setupRenderState, Runnable clearRenderState) {
    ...
    protected static SkinRenderType create(RenderType renderType) {
        return new Wrapper(renderType);
    }

    protected static SkinRenderType.Builder builder(SkinVertexFormat format) {
    ...
    private static class Builder extends SkinRenderType.Builder {
