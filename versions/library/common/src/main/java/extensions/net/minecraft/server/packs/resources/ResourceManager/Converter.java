...
public class Converter {
    ...
    public static ResourceManager newBundleResourceManager(@ThisClass Class<?> clazz, ResourceManager resourceManager) {
        ...
        resourceManager.listPacks().forEach(it -> {
            ...
            if (!(it instanceof FilePackResources) && !(it instanceof PathPackResources)) {
                resources.add(it);
            }
        });
