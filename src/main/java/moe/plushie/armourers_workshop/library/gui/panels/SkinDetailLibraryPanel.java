...
public class SkinDetailLibraryPanel extends AbstractLibraryPanel {
    ...
    public void drawUserbox(MatrixStack matrixStack, int boxX, int boxY, int boxWidth, int boxHeight, int mouseX, int mouseY, float partialTickTime) {
    ...
    public void drawSkinInfo(MatrixStack matrixStack, int boxX, int boxY, int boxWidth, int boxHeight, int mouseX, int mouseY, float partialTickTime) {
        fillGradient(matrixStack, boxX, boxY, boxX + boxWidth, boxY + boxHeight, 0x22888888, 0x22CCCCCC);
        if (message == null) {
            return;
        }
    ...
    public void drawPreviewBox(MatrixStack matrixStack, int boxX, int boxY, int boxWidth, int boxHeight, int mouseX, int mouseY, float partialTickTime) {
        fillGradient(matrixStack, boxX, boxY, boxX + boxWidth, boxY + boxHeight, 0x22888888, 0x22CCCCCC);
    ...
    private void downloadSkin(Button button) {
        ...
        File path = new File(AWCore.getSkinLibraryDirectory(), "downloads");
