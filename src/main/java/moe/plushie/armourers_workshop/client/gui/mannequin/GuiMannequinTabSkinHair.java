...
public class GuiMannequinTabSkinHair extends GuiTabPanel<GuiMannequin> {
    ...
    public void initGui(int xPos, int yPos, int width, int height) {
        ...
        skinColour = tileEntity.PROP_EXTRA_COLOURS.get().getColour(ExtraColourType.SKIN);
        hairColour = tileEntity.PROP_EXTRA_COLOURS.get().getColour(ExtraColourType.HAIR);

        selectSkinButton = new GuiButtonExt(0, width / 2 - 90, 25, 80, 14, GuiHelper.getLocalizedControlName(tileEntity.getName(), "selectSkin"));
        selectHairButton = new GuiButtonExt(0, width / 2 - 90, 40, 80, 14, GuiHelper.getLocalizedControlName(tileEntity.getName(), "selectHair"));

        autoSkinButton = new GuiButtonExt(0, width / 2 + 10, 25, 80, 14, GuiHelper.getLocalizedControlName(tileEntity.getName(), "autoSkin"));
        autoHairButton = new GuiButtonExt(0, width / 2 + 10, 40, 80, 14, GuiHelper.getLocalizedControlName(tileEntity.getName(), "autoHair"));
