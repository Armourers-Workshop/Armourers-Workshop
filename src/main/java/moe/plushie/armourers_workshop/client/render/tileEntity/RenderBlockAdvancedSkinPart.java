...
public class RenderBlockAdvancedSkinPart extends TileEntitySpecialRenderer<TileAdvancedSkinPart> {

    @Override
    public void render(TileAdvancedSkinPart te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
    ...
    @Override
    public boolean isGlobalRenderer(TileAdvancedSkinPart te) {
        return true;
    }
}
