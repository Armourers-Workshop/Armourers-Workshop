...
public class PaintSplashParticle extends RainParticle {
    ...
    private PaintSplashParticle(ClientWorld world, double x, double y, double z, double xd, double yd, double zd, Direction dir) {
        super(world, x, y, z);
    ...
    public static class Factory implements IParticleFactory<PaintSplashParticleData> {
        ...
        public Particle createParticle(PaintSplashParticleData data, ClientWorld world, double x, double y, double z, double xd, double yd, double zd) {
