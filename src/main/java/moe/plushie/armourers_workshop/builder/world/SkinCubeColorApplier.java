...
public class SkinCubeColorApplier {
    ...
    public enum ActionTypes {
        ...
        private final Function<PacketBuffer, Action> factory;

        ActionTypes(Class<? extends Action> packetClass, Function<PacketBuffer, Action> factory) {
    ...
    public static abstract class Action implements IPaintToolAction {
        ...
        public abstract void apply(World world, BlockPos pos, Direction dir, IPaintable provider, @Nullable PlayerEntity player);

        public Action build(World world, BlockPos pos, Direction dir, IPaintable provider, @Nullable PlayerEntity player) {
            return this;
        }

        public abstract void encode(final PacketBuffer buffer);

        public static Action fromBuffer(PacketBuffer buffer) {
            ActionTypes type = buffer.readEnum(ActionTypes.class);
            return type.factory.apply(buffer);
        }

        public static void writeBuffer(IPaintToolAction action, PacketBuffer buffer) {
    ...
    public static abstract class MixedAction extends Action {
        ...
        @Override
        public void apply(World world, BlockPos pos, Direction dir, IPaintable provider, @Nullable PlayerEntity player) {
            if (provider.shouldChangeColor(dir)) {
    ...
    public static class SetAction extends Action {
        ...
        public SetAction(PacketBuffer buffer) {
    ...
    public static class ClearAction extends Action {
        ...
        public ClearAction(PacketBuffer buffer) {
        }
        ...
        public void apply(World world, BlockPos pos, Direction dir, IPaintable provider, @Nullable PlayerEntity player) {
            if (provider.shouldChangeColor(dir)) {
                if (world.getBlockEntity(pos) instanceof BoundingBoxTileEntity) {
    ...
    public static class BrightnessAction extends MixedAction {
        ...
        public BrightnessAction(PacketBuffer buffer) {
    ...
    public static class NoiseAction extends MixedAction {
        ...
        public NoiseAction(PacketBuffer buffer) {
            this.intensity = buffer.readInt();
    ...
    public static class BlendingAction extends MixedAction {
        ...
        public BlendingAction(PacketBuffer buffer) {
            this.destinationColor = PaintColor.of(buffer.readInt());
            this.intensity = buffer.readInt();
        }
