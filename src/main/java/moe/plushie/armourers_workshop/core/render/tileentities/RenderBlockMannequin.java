...
//
//import moe.plushie.armourers_workshop.core.api.common.skin.data.ISkinDescriptor;
...
//import moe.plushie.armourers_workshop.core.Contributors;
//import moe.plushie.armourers_workshop.core.Contributors.Contributor;
//import moe.plushie.armourers_workshop.core.data.type.BipedRotations;
//import moe.plushie.armourers_workshop.core.data.type.BipedRotations.BipedPart;
//import moe.plushie.armourers_workshop.core.holiday.ModHolidays;
...
//
//        int rotaion = te.ROTATION.get();
//        GlStateManager.translate(x + 0.5F + te.OFFSET_X.get(), y + 1F + te.OFFSET_Y.get(), z + 0.5F + te.OFFSET_Z.get());
//        BipedRotations rots = te.BIPED_ROTATIONS.get();
...
//                    if (skins[i] != null) {
//                        if (skins[i].hasPaintData() | SkinProperty.ARMOUR_OVERRIDE.getValue(skins[i].getProperties())) {
//                            hasPaintedSkin = true;
//                        }
//                    }
//                }
...
//        if (te.VISIBLE.get() & !(te.OWNER.get() != null && te.OWNER.get().getName().equalsIgnoreCase("null"))) {
...
//        //Magic circle.
//        if (te.RENDER_EXTRAS.get() & te.VISIBLE.get()) {
//            Contributor contributor = Contributors.INSTANCE.getContributor(te.OWNER.get());
//            if (contributor != null) {
//                int offset = te.getPos().hashCode();
//                renderMagicCircle(mc, contributor.r, contributor.g, contributor.b, partialTicks, offset, te.BIPED_ROTATIONS.get().isChild());
//            }
//        }
//
//        //Render items.
...
//        if (!hasCustomHead(te)) {
//            if (te.BIPED_ROTATIONS.get().isChild()) {
//                ModelHelper.enableChildModelScale(true, SCALE);
//            }
...
//            if (skin != null) {
//                return SkinProperty.MODEL_OVERRIDE_HEAD.getValue(skin.getProperties());
//            }
//        }
//        return false;
//    }
