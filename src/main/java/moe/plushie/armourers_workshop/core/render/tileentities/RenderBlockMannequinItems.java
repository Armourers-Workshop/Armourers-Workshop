...
//            if (sp.getIdentifier().getType() == SkinTypeRegistry.skinSword | sp.getIdentifier().getType() == SkinTypeRegistry.skinBow) {
...
//        if (SkinNBTHelper.stackHasSkinData(stack)) {
//            SkinPointer sp = SkinNBTHelper.getSkinPointerFromStack(stack);
//            if (sp.getIdentifier().getType() == SkinTypes.BIPED_WINGS) {
