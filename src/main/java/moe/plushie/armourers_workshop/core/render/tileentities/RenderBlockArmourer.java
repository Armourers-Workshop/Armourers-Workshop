...
//import moe.plushie.armourers_workshop.core.tileentities.TileEntityArmourer;
...
//            ArmourerRenderHelper.renderBuildingGrid(skinType, scale, te.isShowGuides(), te.getSkinProps(), SkinProperty.BLOCK_MULTIBLOCK.getValue(te.getSkinProps()));
//            mc.mcProfiler.endSection();
