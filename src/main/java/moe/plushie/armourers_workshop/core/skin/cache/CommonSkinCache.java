package moe.plushie.armourers_workshop.core.skin.cache;//package moe.plushie.armourers_workshop.core.skin.cache;
//
...
//import moe.plushie.armourers_workshop.core.api.common.skin.data.ISkinIdentifier;
...
//import moe.plushie.armourers_workshop.core.data.type.ExpiringHashMap.IExpiringMapCallback;
//import moe.plushie.armourers_workshop.core.library.LibraryFile;
//import moe.plushie.armourers_workshop.core.network.PacketHandler;
//import moe.plushie.armourers_workshop.core.network.messages.server.MessageServerSendSkinData;
...
//        } else {
//            SkinLogger.error("Player " + player.getName() + " requested a skin with no vaid ID:" + identifier.toString());
//        }
//    }
//
...
//        } else {
//            SkinLogger.error("Server requested a skin with no vaid ID:" + identifier.toString());
//            return null;
//        }
//    }
//
