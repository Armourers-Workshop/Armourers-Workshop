...
//import moe.plushie.armourers_workshop.core.skin.entity.ISkinnableEntity;
//import moe.plushie.armourers_workshop.core.skin.entity.ISkinnableEntityRegisty;
...
//import moe.plushie.armourers_workshop.core.library.ILibraryManager;
//import moe.plushie.armourers_workshop.core.library.LibraryFile;
//import moe.plushie.armourers_workshop.core.library.LibraryFileList;
...
//            SkinLogger.warn("A mod tried to register a null skinnable entity.");
//            return;
//        }
//        if (skinnableEntity.getEntityClass() == null) {
//            SkinLogger.warn("A mod tried to register a skinnable entity with a null class.");
//            return;
//        }
...
//                ArrayList<ISkinType> skinTypes = entityEquipmentData.getSkinInventory().getTypes();
