...
//import moe.plushie.armourers_workshop.core.data.type.BidirectionalHashMap;
//import moe.plushie.armourers_workshop.core.library.global.SkinDownloader.DownloadSkinCallable;
...
//                     }
//                 } else {
//                     SkinLogger.error("Failed to load skin from global database.");
//                 }
//             } catch (Exception e) {
//                 e.printStackTrace();
//             }
...
//                 SkinIdentifier newIdentifier = new SkinIdentifier(id, null, globalId, identifier.getType());
...
//                     SkinLogger.error("Skin [" + identifier.toString() + "] was requested by " + requestMessage.getPlayer().getName() + " but was not found.");
//                 } else {
//                     SkinLogger.error("Skin [" + identifier.toString() + "] was requested but was not found.");
//                 }
//             }
//         }
//         return null;
