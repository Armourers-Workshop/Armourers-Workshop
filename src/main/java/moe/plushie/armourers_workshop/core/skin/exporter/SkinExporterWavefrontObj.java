...
//                }
//            }
//            SkinLogger.log("Exporting skin with " + totalFaces + " total faces.");
//
//            int textureSize = 0;
//            while (textureSize * textureSize < totalFaces * 4) {
//                SkinLogger.log("Texture size " + textureSize);
...
//
//        os.write("o " + partIndex + "-" + skinPart.getType().getRegistryName().replace(":", "_") + "-" + layerNames[layer] + CRLF);
