...
public final class SkinPartSerializerV12 {
    ...
    public static String getTypeNameByLegacyId(int legacyId) {
        switch (legacyId) {
            case 0: return "armourers:head.base";
            case 1: return "armourers:chest.base";
            case 2: return "armourers:chest.leftArm";
            case 3: return "armourers:chest.rightArm";
            case 4: return "armourers:legs.leftLeg";
            case 5: return "armourers:legs.rightLeg";
            case 6: return "armourers:skirt.base";
            case 7: return "armourers:feet.leftFoot";
            case 8: return "armourers:feet.rightFoot";
            case 9: return "armourers:sword.base";
            case 10: return "armourers:bow.base";
            default: return null;
        }
    }
    ...
    public static SkinPart loadSkinPart(DataInputStream stream, int version) throws IOException, InvalidCubeTypeException {
        ...
        if (version < 6) {
            ...
            if (skinPartType == null) {
                SkinLog.error("Skin part was null");
        ...
        return new SkinPart(cubeData, skinPartType, markerBlocks);
    }
