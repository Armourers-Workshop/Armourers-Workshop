...
//                SkinIdentifier newIdentifier = new SkinIdentifier(id, requestMessage.getSkinIdentifier().getSkinLibraryFile(), 0, requestMessage.getSkinIdentifier().getType());
...
//                    SkinLogger.error("Skin [" + libraryFile.getFullName() + "] was requested by " + requestMessage.getPlayer().getName() + " but was not found.");
//                } else {
//                    SkinLogger.error("Skin [" + libraryFile.getFullName() + "] was requested but was not found.");
//                }
//            }
//        }
//        return null;
