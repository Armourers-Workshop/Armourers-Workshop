...
@OnlyIn(Dist.CLIENT)
public class HologramProjectorRotationOffsetSetting extends WardrobeBaseSetting {
    ...
    public HologramProjectorRotationOffsetSetting(HologramProjectorContainer container) {
        super("inventory.armourers_workshop.hologram-projector.tab.rotationOffset");
    }
