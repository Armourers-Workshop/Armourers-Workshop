...
@OnlyIn(Dist.CLIENT)
public class HologramProjectorAngleSetting extends WardrobeBaseSetting {

    protected int contentWidth = 200;
    protected int contentHeight = 82;

    public HologramProjectorAngleSetting(HologramProjectorContainer container) {
        super("inventory.armourers_workshop.hologram-projector.tab.angle");
    }
