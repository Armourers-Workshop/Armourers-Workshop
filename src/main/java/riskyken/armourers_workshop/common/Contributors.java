package riskyken.armourers_workshop.common;
...
public class Contributors {
    ...
    public Contributors() {
        ...
        addContributor("b9e99f95-09fe-497a-8a77-1ccc839ab0f4", "VermillionX", EnumSet.of(ContributionFlags.MODELER), 45, 45, 45);
        addContributor("0d98df01-26da-496c-ba7c-744a20a7b2c2", "Servantfly", EnumSet.of(ContributionFlags.MODELER), 0, 247, 141);
        addContributor("eda5e4cb-3b09-4b2c-b56c-d27d658d2e5d", "Gray_Mooo", EnumSet.of(ContributionFlags.MODELER), 255, 0, 0);
        addContributor("3e6a5f19-bb37-4f9a-94e0-7ccd67ef1d61", "Flummie2000", EnumSet.of(ContributionFlags.MODELER, ContributionFlags.TRANSLATOR), 92, 32, 102);
        ...
        addContributor("d7d977c8-b264-49a3-ac6e-2fae419c8191", "Thundercat_", EnumSet.of(ContributionFlags.ARTIST), 74, 89, 169);
