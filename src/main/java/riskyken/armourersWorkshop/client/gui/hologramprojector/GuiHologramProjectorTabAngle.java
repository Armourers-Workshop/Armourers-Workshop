...
public class GuiHologramProjectorTabAngle extends GuiTabPanel implements ISlider {
    ...
    public void initGui(int xPos, int yPos, int width, int height) {
        ...
        sliderOffsetY = new GuiCustomSlider(-1, (int)((width / 2F) - (200 / 2F)) + 10, 40, 178, 10, "Y: ", DEGREE, -180D, 180D, tileEntity.getAngleY(), false, true, this);
        sliderOffsetZ = new GuiCustomSlider(-1, (int)((width / 2F) - (200 / 2F)) + 10, 50, 178, 10, "Z: ", DEGREE, -180D, 180D, tileEntity.getAngleZ(), false, true, this);
