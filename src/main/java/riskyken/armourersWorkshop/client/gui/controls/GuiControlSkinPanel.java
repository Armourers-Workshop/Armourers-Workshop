    ...
    public class SkinIcon {
        ...
        public void drawIcon(int x, int y, int mouseX, int mouseY, int iconSize, boolean showName) {
            ...
            if (skin != null) {
                ...
                IIcon skinIcon = skin.getSkinType().getIcon();
                if (skinIcon != null) {
                    ...
                    drawTexturedModelRectFromIcon(x, y, skinIcon, 10, 10);
                }
                ...
                Gui.func_152125_a(x + 8, y + 8, u * 28, v * 28, 27, 27, iconSize - 16, iconSize - 16, 256, 256);
            }
        }
