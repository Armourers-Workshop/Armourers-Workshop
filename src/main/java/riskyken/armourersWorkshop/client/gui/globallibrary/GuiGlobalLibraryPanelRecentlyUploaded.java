        ...
        synchronized (skins) {
            for (int i = 0; i < skins.size(); i++) {
                ...
                if (y <= colSize) {
                    ...
                    GL11.glTranslatef(this.x + iconSize / 2 + x * iconSize, 12 + this.y + iconSize / 2 + y * 40, 200.0F);
                    ...
                    ItemStackRenderHelper.renderItemModelFromSkin(skin, skinPonter, true, false);
                    GL11.glPopAttrib();
                    GL11.glPopMatrix();
                }
