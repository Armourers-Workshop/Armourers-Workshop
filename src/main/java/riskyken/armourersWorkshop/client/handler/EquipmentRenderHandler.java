...
public class EquipmentRenderHandler implements IEquipmentRenderHandler {
    ...
    public void renderCustomEquipmentFromStack(ItemStack stack) {
        EquipmentModelRender.INSTANCE.renderEquipmentPartFromStack(stack, null);
    }

    @Override
    public void renderCustomEquipmentFromStack(ItemStack stack, ModelBiped modelBiped) {
        EquipmentModelRender.INSTANCE.renderEquipmentPartFromStack(stack, modelBiped);
    }

    @Override
    public void renderCustomEquipmentFromStack(ItemStack stack, float limb1, float limb2, float limb3, float headY, float headX) {
        EquipmentModelRender.INSTANCE.renderEquipmentPartFromStack(stack, limb1, limb2, limb3, headY, headX);
    }
    ...
    public void renderCustomEquipmentFromStack(ItemStack[] stack) {
        if (stack != null) {
            for (int i = 0; i < stack.length; i++) {
                EquipmentModelRender.INSTANCE.renderEquipmentPartFromStack(stack[i], null);
            }
        }
    }
    ...
    public void renderCustomEquipmentFromStack(ItemStack[] stack, ModelBiped modelBiped) {
        if (stack != null) {
            for (int i = 0; i < stack.length; i++) {
                EquipmentModelRender.INSTANCE.renderEquipmentPartFromStack(stack[i], modelBiped);
            }
        }
    }
    ...
    public void renderCustomEquipmentFromStack(ItemStack stack[], float limb1, float limb2, float limb3, float headY, float headX) {
        if (stack != null) {
            for (int i = 0; i < stack.length; i++) {
                EquipmentModelRender.INSTANCE.renderEquipmentPartFromStack(stack[i], limb1, limb2, limb3, headY, headX);
            }
        }
    }
