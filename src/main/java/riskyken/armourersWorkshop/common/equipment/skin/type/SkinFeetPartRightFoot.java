...
public class SkinFeetPartRightFoot extends EquipmentSkinPartBase implements IEquipmentSkinPartTextured {
    ...
    public SkinFeetPartRightFoot(IEquipmentSkinType baseType) {
        super(baseType);
