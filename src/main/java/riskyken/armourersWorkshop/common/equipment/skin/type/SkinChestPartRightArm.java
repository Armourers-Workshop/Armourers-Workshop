...
public class SkinChestPartRightArm extends EquipmentSkinPartBase implements IEquipmentSkinPartTextured {
    ...
    public SkinChestPartRightArm(IEquipmentSkinType baseType) {
        super(baseType);
