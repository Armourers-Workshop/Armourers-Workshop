...
import moe.plushie.armourers_workshop.builder.client.render.guide.*;
...
public class ArmourerBlockRenderer<T extends ArmourerBlockEntity> extends BlockEntityRenderer<T> {
    ...
    public ArmourerBlockRenderer(BlockEntityRenderDispatcher rendererManager) {
