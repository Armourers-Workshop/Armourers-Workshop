...
public class SkinCubeBlockRenderer<T extends BlockEntity & IPaintable & IExtendedBlockEntityRenderer> extends BlockEntityRenderer<T> {

    private static float markerAlpha = 0F;
    private static long lastWorldTimeUpdate;

    public SkinCubeBlockRenderer(BlockEntityRenderDispatcher rendererManager) {
