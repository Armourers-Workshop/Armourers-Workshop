...
public class ArmourerCopyDialog extends ConfirmDialog {
    ...
    private void setup() {
        ...
        var right = cancelButton.frame().maxX() - 1;
        ...
        UILabel label1 = new UILabel(new CGRect(sourcePartComboBox.frame().x(), sourcePartComboBox.frame().y() - 10, 100, 9));
        UILabel label2 = new UILabel(new CGRect(destinationPartComboBox.frame().x(), destinationPartComboBox.frame().y() - 10, 100, 9));
