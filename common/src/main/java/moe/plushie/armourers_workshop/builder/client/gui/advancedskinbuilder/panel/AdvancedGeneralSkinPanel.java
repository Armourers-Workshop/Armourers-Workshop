...
public class AdvancedGeneralSkinPanel extends AdvancedSkinPanel {
    ...
    private void setup() {
        ...
        addGroup(translatable("transform"), builder -> {
            builder.vector(translatable("location"), blockEntity.location2, null);
            builder.vector(translatable("rotation"), blockEntity.rotation2, null);
            builder.vector(translatable("scale"), blockEntity.scale2, null);
        });
    }
}
