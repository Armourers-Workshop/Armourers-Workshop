...
public class HologramProjectorRotationSpeedSetting extends HologramProjectorBaseSetting {
    ...
    private UISliderBox setupSlider(int x, int y, String key, double value) {
        ...
        slider.setMinValue(-10000);
        slider.setMaxValue(10000);
        slider.setFormatter(currentValue -> new NSString(String.format("%s%.0fms", key, currentValue)));
        slider.addTarget(this, UIControl.Event.VALUE_CHANGED, HologramProjectorRotationSpeedSetting::updateValue);
        slider.addTarget(this, UIControl.Event.EDITING_DID_END, HologramProjectorRotationSpeedSetting::didUpdateValue);
