...
public class SkinnableBlockRenderer<T extends SkinnableBlockEntity> extends BlockEntityRenderer<T> {

    public SkinnableBlockRenderer(BlockEntityRenderDispatcher rendererManager) {
