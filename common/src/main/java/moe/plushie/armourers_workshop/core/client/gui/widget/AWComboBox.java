...
public class AWComboBox extends Button {
    ...
    public AWComboBox(int x, int y, int width, int height, List<ComboItem> items, int selectedIndex, Button.OnPress changeHandler) {
    ...
    public void renderButton(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.drawContinuousTexturedBox(matrixStack, x, y, 0, 46, width, height, 200, 20, 2, 3, 2, 2, 0);
        RenderUtils.drawContinuousTexturedBox(matrixStack, handX, handY, 0, 66 + 20 * k, handWidth, handHeight, 200, 20, 2, 3, 2, 2, 0);
    ...
    public static class ComboItem extends ContainerObjectSelectionList.Entry<ComboItem> {
        ...
        public ComboItem(Component title) {
            this.title = title;
            this.font = Minecraft.getInstance().font;
        }
        ...
        public void renderLabels(PoseStack matrixStack, int x, int y, int width, int height, boolean isHovered, boolean isTopRender) {
        ...
        public void renderBackground(PoseStack matrixStack, int x, int y, int width, int height, boolean isHovered, boolean isTopRender) {
        ...
        public void render(PoseStack matrixStack, int x, int y, int width, int height, int mouseX, int mouseY, float partialTicks, boolean isTopRender) {
    ...
    public class ComboItemList extends ContainerObjectSelectionList<ComboItem> {
