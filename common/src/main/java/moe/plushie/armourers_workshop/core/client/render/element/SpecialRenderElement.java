...
import moe.plushie.armourers_workshop.compat.client.renderer.element.AbstractBlockRendererElement;
import moe.plushie.armourers_workshop.compat.client.renderer.element.AbstractEntityRendererElement;
import moe.plushie.armourers_workshop.compat.client.renderer.element.AbstractModelRendererElement;
...
public abstract class SpecialRenderElement implements IGraphicsElement {
    ...
    public static SpecialRenderElement entity(Entity entity, float f, float partialTicks, int lightmap, int overlay) {
        return AbstractEntityRendererElement.newInstance(entity, f, partialTicks, lightmap, overlay);
    }
