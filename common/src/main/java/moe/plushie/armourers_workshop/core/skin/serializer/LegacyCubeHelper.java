...
public final class LegacyCubeHelper {
    ...
    public static void loadLegacyCubeData(SkinCubesV1 cubeData, SkinCubesV1.BufferSlice slice, IInputStream input, int version, ISkinPartType skinPart) throws IOException {
        if (version < 3) {
