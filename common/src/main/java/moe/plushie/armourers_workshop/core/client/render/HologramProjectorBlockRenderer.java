...
public class HologramProjectorBlockRenderer<T extends HologramProjectorBlockEntity> extends BlockEntityRenderer<T> {

    public HologramProjectorBlockRenderer(BlockEntityRenderDispatcher rendererManager) {
