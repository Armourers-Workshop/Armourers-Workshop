...
public class GlobalSkinLibraryWindow extends MenuWindow<GlobalSkinLibraryMenu> {
    ...
    private void setupLibrary() {
        ...
        GlobalSkinLibrary.getInstance().executor(EnvironmentManager.getClientExecutor());
        GlobalSkinLibrary.getInstance().connect(EnvironmentManager.getClientUser(), null);
    }
