...
public final class ModBlockEntityTypes {
    ...
    public static final IRegistryKey<IBlockEntityType<HologramProjectorBlockEntity>> HOLOGRAM_PROJECTOR = create(HologramProjectorBlockEntity::new).of(ModBlocks.HOLOGRAM_PROJECTOR).bind(() -> HologramProjectorBlockEntityRenderer::new).build(ModConstants.BLOCK_HOLOGRAM_PROJECTOR);
    ...
    public static final IRegistryKey<IBlockEntityType<SkinnableBlockEntity>> SKINNABLE = create(SkinnableBlockEntity::new).of(ModBlocks.SKINNABLE).bind(() -> SkinnableBlockEntityRenderer::new).build(ModConstants.BLOCK_SKINNABLE);
    public static final IRegistryKey<IBlockEntityType<BoundingBoxBlockEntity>> BOUNDING_BOX = create(BoundingBoxBlockEntity::new).of(ModBlocks.BOUNDING_BOX).bind(() -> SkinCubeBlockEntityRenderer::new).build(ModConstants.BLOCK_BOUNDING_BOX);
    public static final IRegistryKey<IBlockEntityType<SkinCubeBlockEntity>> SKIN_CUBE = create(SkinCubeBlockEntity::new).of(ModBlocks.SKIN_CUBE).of(ModBlocks.SKIN_CUBE_GLASS).of(ModBlocks.SKIN_CUBE_GLASS_GLOWING).of(ModBlocks.SKIN_CUBE_GLOWING).bind(() -> SkinCubeBlockEntityRenderer::new).build(ModConstants.BLOCK_SKIN_CUBE);
