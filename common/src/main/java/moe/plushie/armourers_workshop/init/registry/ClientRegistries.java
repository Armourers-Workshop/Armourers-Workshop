...
public class ClientRegistries {
    ...
    public static final TypedRegistry<SpecialModelRendererType<?>> SPECIAL_MODEL_RENDERER_TYPES = create("Special Model Renderer", ClientRegistryFactory::specialModelRendererType);
