 ...
 * <p>
 * To create an instance of this class, use {@link #of(Supplier)}. Note
 * that this accepts a {@link Supplier}, so the result of the supplier
 * must never be null.
 * <p>
...
public class LazyOptional<T> {
    ...
    private final HashSet<Consumer<LazyOptional<T>>> listeners = new HashSet<>();
     ...
     * {@link Supplier}.
     *
     * @param instanceSupplier The {@link Supplier} to wrap. Cannot return
     ...
     * {@link Predicate}, returning empty if false.
     * <p>
     ...
     * predicate.</em>
     *
     * @param predicate A {@link Predicate} to apply to the result of the
     *                  contained supplier, if non-empty
     * @return An {@link Optional} containing the result of the contained
     * supplier, if and only if the passed {@link Predicate} returns
     ...
     *
     * @param other A {@link Supplier} whose result is returned if this
     ...
     * exception created by the provided {@link Supplier}.
     *
     * @param <X>               Type of the exception to be thrown
     * @param exceptionSupplier The {@link Supplier} which will return the
    ...
    /**
     * Register a {@link Consumer listener} that will be called when this {@link LazyOptional} becomes invalid (via {@link #invalidate()}).
     * <p>
     ...
     * and notifying any {@link #addListener(Consumer) listeners} that this
