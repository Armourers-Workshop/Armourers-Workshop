...
public class VoxelShapeX {
    ...
    public static VoxelShapeX empty() {
        return new VoxelShapeX();
    }

    public static VoxelShapeX box(Rectangle3f bounds) {
        VoxelShapeX shape = new VoxelShapeX();
        shape.box = bounds;
        return shape;
    }
    ...
    public void add(VoxelShapeX shape1) {
        List<Vector4f> list = getVertexes();
