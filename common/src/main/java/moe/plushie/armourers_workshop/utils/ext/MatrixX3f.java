...
public class MatrixX3f extends Matrix3f {

    public MatrixX3f() {
        super();
    }

    public MatrixX3f(Quaternion quaternion) {
        super(quaternion);
    }

    public MatrixX3f(Matrix3f matrix) {
        super(matrix);
    }

    public static MatrixX3f createScaleMatrix(float x, float y, float z) {
        MatrixX3f matrix = new MatrixX3f();
        matrix.m00 = x;
        matrix.m11 = y;
        matrix.m22 = z;
        return matrix;
    ...
    public static MatrixX3f fromFloatBuffer(float[][] values) {
        MatrixX3f matrix = new MatrixX3f();
    ...
    public static float[][] toFloatBuffer(Matrix3f matrix) {
        if (matrix instanceof MatrixX3f) {
            return ((MatrixX3f) matrix).toArray();
        }
        return new MatrixX3f(matrix).toArray();
    }
    ...
    public void multiply(Quaternion other) {
        this.multiply(new MatrixX3f(other));
    }
